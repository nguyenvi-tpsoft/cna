                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="item-img img-left">
                            ...
                            <a href="{{URL::to('chi-tiet-diem-tin/'.$dt->ID_DT)}}" title=""><img style="width: 100%" src="{{URL::to('public/upload/'.$dt->HINHANH_DT)}}" alt="img"></a> @endforeach
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="row" style=" display: block;">
                                        ...
                                        <div class="index-core-group flex-center clearfix  align-items-center">
                                            <div class="item-img float-left" style="width: 16rem">
                                                <a href="{{URL::to('chi-tiet-diem-tin/'.$dt->ID_DT)}}" title=""><img class="img-fluid" style="height: 10rem; width: 100%;" src="{{URL::to('public/upload/'.$dt->HINHANH_DT)}}"></a>
                                            </div>
