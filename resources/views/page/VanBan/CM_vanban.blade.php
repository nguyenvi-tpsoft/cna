                            ...
                            <div class="row" style="margin-bottom: 50px">
                                    ...
                                    <div class="product-thumb">
                                        <div class="product-container item-img">
                                            <div class="product-image-container">
                                                <a class="product-img-link" href="{{URL::to('chi-tiet-van-ban/'.$chuyenmuc->ID_VB)}}" title=""><img class="w-100" src="{{URL::to('public/upload/'.$chuyenmuc->HINHANH_VB)}}" alt="img" style="height: 20rem; border-radius: 0.5rem">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7 col-sm-12">
                                    <div class="content-right" style="color: black">
                                        <a href="{{URL::to('chi-tiet-van-ban/'.$chuyenmuc->ID_VB)}}">
                                        ...
                                        <div class="button d-flex align-items-center" style="margin-top: 3rem">
                                            <a class="btn view button-main" href="{{URL::to('chi-tiet-van-ban/'.$chuyenmuc->ID_VB)}}" style="background-color: rgba(0,0,0,0.02);
