                          ...
                          <td>
                            <textarea id='tt_vpcc' name='tt_vpcc' rows='8' cols='40 value=''><?php echo $row['THONGTIN_VPCC'] ?></textarea>
                                <script >
                                    ...
                                    CKEDITOR.config.language = ' Vi'; CKEDITOR.config.htmlEncodeOutput=false; CKEDITOR.config.ProcessHTMLEntities=false; CKEDITOR.config.entities=false; CKEDITOR.config.entities_latin=false; CKEDITOR.config.ForceSimpleAmpersand=true; var editor=CKEDITOR.replace( 'tt_vpcc' ); CKFinder.setupCKEditor( editor ); </script>
