                  ...
                  <form action="themhoivien.php" method="POST" enctype="multipart/form-data">
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          <th> </th>
                          <th style="font-size:18px; text-align: left;"> Thêm hội viên</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <th>Tên hội viên</th>
                          <td><input type="text" name="tenhoivien" value=""></td>
                        </tr>
                        <th>Nơi làm việc</th>
                        <td><input type="text" name="vpcc_hv" value=""></td>
                        </tr>
                        <tr>
                          <th>Hình ảnh hội viên</th>
                          <td><input type="file" name="anh_hv" value=""></td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<tr>
                               <td >" . $stt . " </td>
                               <td >" . $row['TEN_HV'] . "</td>
                               <td >" . $row['VANPHONG_HV'] . "</td>
                               <td ><img src='https://cna.org.vn/public/upload" . $row['ANH_HV'] . "'></td>
                               <td ><a href='suahoivien.php?id_hv=" . $row['ID_HV'] . "'><label class='badge badge-info'>Sửa</label></a></td>
                               <td ><a href='xoahoivien.php?id_hv=" . $row['ID_HV'] . "'><label class='badge badge-danger'>Xóa</label></a></td>
                               </tr>";
                    }
                    echo "</tbody></table>";
                    $con->close();
