                  ...
                  <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      if ($row['ID_CHUYENMUC_TV'] != $video) {
                        echo "<td > <img src='https://cna.org.vn/public/upload" . $row['FILE_TV'] . "' alt='' style='width:150px;height: 150px;'></td>";
                      }
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      while ($row = $result->fetch_assoc()) {
                        ...
                        if ($row['ID_CHUYENMUC_TV'] == $video) {
                          echo "<td > <video controls width='320px' height='200px' ><source src='https://cna.org.vn/public/upload" . $row['FILE_TV'] . "  '> </video></td>";
                        }
                        echo "
